...
<script>
  $("#map").vectorMap({
    ...
    markers: [
      ...
      { latLng: [36.060798, 103.834228], name: "兰州" },
      { latLng: [36.578234, 100.490045], name: "青海湖" },
      { latLng: [36.793387, 99.076943], name: "茶卡镇" },
      { latLng: [37.866427, 95.265841], name: "大柴旦" },
      { latLng: [36.949738, 95.192077], name: "察尔汗" },
      { latLng: [36.407272, 94.928293], name: "格尔木" },
      { latLng: [35.639114, 94.067003], name: "可可西里" },
      { latLng: [40.142141, 94.662010], name: "敦煌" },
      { latLng: [39.800827, 98.227762], name: "嘉峪关" },
      { latLng: [38.924766, 100.449858], name: "张掖" },
      { latLng: [38.177112, 100.253211], name: "祁连县" },
    ],
    series: {
      regions: [
        {
